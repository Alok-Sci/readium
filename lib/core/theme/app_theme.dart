...
class AppTheme {
  ...
  static const Color lightSurface = Color.fromARGB(255, 255, 255, 255); // #fafafa
  static const Color lightPrimaryText = Color(0xFF242424); // #242424 (headings)
  static const Color lightSecondaryText =
      Color(0xFF6B6B6B); // #6b6b6b (subtitle/meta)
  ...
  static TextStyle darkTitle(BuildContext context) =>
      lightTitle(context).copyWith(
        color: darkPrimaryText,
      );

  static TextStyle darkScreenTitle(BuildContext context) =>
      lightScreenTitle(context).copyWith(
        color: darkPrimaryText.withAlpha(210),
      );

  static TextStyle darkSubtitle(BuildContext context) =>
      lightSubtitle(context).copyWith(
        color: darkPrimaryText,
      );

  static TextStyle darkHeading(BuildContext context) =>
      lightHeading(context).copyWith(
        color: darkPrimaryText,
      );

  static TextStyle darkSubheading(BuildContext context) =>
      lightSubheading(context).copyWith(
        color: darkPrimaryText,
      );

  static TextStyle darkBody(BuildContext context) =>
      lightBody(context).copyWith(
        color: darkPrimaryText,
      );

  static TextStyle darkMeta(BuildContext context) =>
      lightMeta(context).copyWith(
        color: darkPrimaryText,
      );
  static TextStyle darkCaption(BuildContext context) =>
      lightCaption(context).copyWith(
        color: darkSecondaryText,
      );

  static TextStyle darkCodeInline(BuildContext context) =>
      lightCodeInline(context).copyWith(
        color: darkPrimaryText,
        backgroundColor: darkCodeBg, 
      );

  static TextStyle darkCodeBlock(BuildContext context) =>
      lightCodeBlock(context).copyWith(
        color: darkPrimaryText,
        backgroundColor: darkCodeBg,
      );
  ...
  /// Spacing (Mobile)
  static const EdgeInsets screenPaddingEdgeInsets =
